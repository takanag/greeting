...
## 問題
`https://benri.website/greeting/2026` で404エラーが発生する

## 考えられる原因と対処法

### 1. データベースに2026年のデータが存在しない
...
- 本番環境のSupabaseデータベースにデータが存在するか確認
